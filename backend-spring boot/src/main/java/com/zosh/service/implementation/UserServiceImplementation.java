...
//		System.out.println("email user "+user.get().getEmail());
	...
	public void sendPasswordResetEmail(User user) {
        ...
        sendEmail(user.getEmail(), "Đặt lại mật khẩu", "Nhấp vào liên kết sau để đặt lại mật khẩu của bạn: http://localhost:3000/account/reset-password?token=" + resetToken);
	}
