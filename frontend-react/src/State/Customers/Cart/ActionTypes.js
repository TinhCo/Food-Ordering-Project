...
// actionTypes.js
export const FIND_NEW_ITEMS_SUCCESS = "FIND_NEW_ITEMS_SUCCESS";
export const FIND_POPULAR_ITEMS_SUCCESS = "FIND_POPULAR_ITEMS_SUCCESS";
export const FIND_DISCOUNTED_ITEMS_SUCCESS = "FIND_DISCOUNTED_ITEMS_SUCCESS";
