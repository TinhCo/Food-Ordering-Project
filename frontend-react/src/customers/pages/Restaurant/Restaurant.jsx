...
const foodTypes = [
  ...
  { label: "Mặn", value: "non_vegetarian" },
  { label: "Mùa vụ", value: "seasonal" },
];
...
const Restaurant = () => {
  ...
  const currentItems = menu.menuItems.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <>
      <div className="px-5 lg:px-20">
        ...
        <section className="pt-[2rem] lg:flex relative">
          ...
          <div className="lg:w-[80%] space-y-5 lg:pl-10 flex flex-col">
