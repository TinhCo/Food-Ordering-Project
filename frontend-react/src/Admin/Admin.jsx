...
import CreateUser from "./UserAdmin/CreateUser";
import TopicAdmin from "./TopicAdmin/TopicAdmin";
import EditTopic from "./TopicAdmin/EditTopic";
import CreateTopic from "./TopicAdmin/CreateTopic";
import PostAdmin from "./PostAdmin/PostAdmin";
import CreatePost from "./PostAdmin/CreatePost";
      ...
      <div className="lg:flex justify-between">
        ...
        <div className="lg:w-[80vw]">
          <Routes>
            ...
            <Route path="/topic-post" element={<TopicAdmin />} />
            <Route path="/topic-post/:id" element={<EditTopic />} />
            <Route path="/topic-post/add-topic" element={<CreateTopic />} />
            <Route path="/post" element={<PostAdmin title="bài viết" />} />
            <Route path="/post/add-post" element={<CreatePost />} />
          </Routes>
        </div>
      </div>
    </div>
