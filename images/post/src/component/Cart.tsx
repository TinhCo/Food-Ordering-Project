...
import { List, useRecordContext, ReferenceField, TextField, Show, SimpleShowLayout, NumberField, ArrayField, ImageField, Datagrid, Identifier, useRedirect, useNotify, useRefresh } from 'react-admin';
            ...
            <SimpleShowLayout>
                ...
                <ArrayField source="products" label="Products">
                    <Datagrid>
                        ...
                        <ReferenceField source="categories.categoryId" reference="categories" label="Category">
